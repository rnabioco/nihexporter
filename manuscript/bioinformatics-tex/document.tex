...
\title[The nihexporter package for analysis of NIH funding data in R]{This is a title}
\author[Sample \textit{et~al}]{Jay R. Hesselberth\,$^{1,*}$, Co-Author\,$^{2}$ and Co-Author\,$^2$\footnote{to whom correspondence should be addressed}}
\address{$^{1}$Department of Biochemistry and Molecular Genetics, Address XXXX etc.\\
...
\section{Motivation:}
The NIH provides funding information through its NIH EXPORTER website, but
there are no common facilities to enable exploratory analysis of this
data.

\section{Results:}
We developed an R data package `nihexporter` that contains the NIH
EXPORTER data from fiscal years 2000-2014. The data are in `tidy` format,
which makes them suitable for a variety of analyses and visualizations.

\section{Availability:}
The package is available at
\url{https://github.com/jayhesselberth/nihexporter}.

\section{Contact:} \href{jay.hesselberth@gmail.com}{jay.hesselberth@gmail.com}
\end{abstract}
