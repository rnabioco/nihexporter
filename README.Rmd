...
Let's look at the amounts spent on grants at each institute since fiscal year 2000:
...
See the [vignette](http://rpubs.com/jayhesselberth/64386) or the [vignette source](vignettes/nihexporter.Rmd) for more examples.
