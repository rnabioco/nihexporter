...
The `nihexporter` R package provides a minimal set of data from the [NIH EXPORTER](https://reporter.nih.gov/exporter) database, which contains information on NIH biomedical research funding from 1985-2024.
...
⚠️**Note:** this is a large data package (>50 Mb) and will take some time to download and install. ⚠️
