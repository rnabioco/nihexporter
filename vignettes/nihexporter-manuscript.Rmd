...
author: Jay Hesselberth, Erin Baschal, Nick Ellinwood, Ashley Pacheco, Sally Peach,
  Mary Sweet, Yuying Wang
...
```{r activity_comparisons, fig.cap = 'Comparison of research, program and contract costs over time'}
...
```{r geography, fig.cap = 'Geographic distribution of NIH dollars', warning = FALSE, message = FALSE}
